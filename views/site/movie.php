<div class="row margin justify-content-around  MyMovies" style="padding-top: 50px;" id="colorposter">
    ...
    <div class="col-md-6 col-sm-12 col-lg-6 text-center">
        <a href="#">
            <figure class="figure">
                <img src="<?php echo 'images/'.$contentForMovie['movies_url_poster'] ?>" class="figure-img rounded" alt="...">
    ...
    <div class="col-lg-6">
        <ul class="film-main-info">
            <li>
                <span><h2><?php echo $contentForMovie["movies_name"]; ?></h2></span>
<p>The Ticket</p>
</li>
<li>
...
<li>
    ...
    <span class="value"><?php echo $contentForMovie['movies_date'] ?></span>
</li>
<li>
...
<li>
    ...
    <span class="value"><?php echo $contentForMovie['genres_name'] ?></span>
</li>
<li>
...
<div class="col-lg-12 video">
    <span><h2 class="heading"><?php echo 'Смотреть фильм '.$film['movies_name'].' онлайн.'; ?></h2></span>
