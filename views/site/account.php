    ...
    <div class="account col-md-12 col-sm-12 col-lg-12 text-center row justify-content-center" id="account">
        ...
        <ul class="menu col-md-4 col-sm-4 col-lg-4" id="menu">
            <div class="row">
                ...
                <li class="nav-item">
                    <a class="nav-link color-white font-weight-600 col-md-9 col-sm-9 col-lg-9" id="login" href="<?php echo Url::to(['site/newItems']); ?>"><?php $name = Yii::$app->user->getIdentity()->name; ?><span class="sr-only">(current)</span></a>
                </li>
            </div>
            <li class="nav-item">
