...
<?php
if( !preg_match('/\/account/', $_SERVER['REQUEST_URI'], $matches, PREG_OFFSET_CAPTURE) || !preg_match('/\/login/', $_SERVER['REQUEST_URI'], $matches, PREG_OFFSET_CAPTURE) || !preg_match('/\/join/', $_SERVER['REQUEST_URI'], $matches, PREG_OFFSET_CAPTURE))
{
